...
app.add_url_rule('/cart/<flight_id>', 'update-cart', controllers.update_cart, methods=['put'])
app.add_url_rule('/cart/<flight_id>', 'delete-cart', controllers.delete_cart, methods=['delete'])
